...
const inputRule = new InputRule(/x$/, "x")
const inputRulesExtension = Extension.InputRules(inputRule)

expectTypeOf(inputRulesExtension.spec.inputRules).toEqualTypeOf<readonly [typeof inputRule]>()
